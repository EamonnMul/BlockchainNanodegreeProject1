...
class Block {
    ...
    validate() {
        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                 ...
                 let auxilaryHash = self.hash;
                 // Recalculate the hash of the Block
                 self.hash = null;
                 const calculationHash = SHA256(JSON.stringify(self)).toString();
                 self.hash = auxilaryHash;
                 // Comparing if the hashes changed
                 // Returning the Block is not valid
                if (auxilaryHash != calculationHash) {
    ...
    getBData() {
        ...
        const block = JSON.parse(dcdData);
